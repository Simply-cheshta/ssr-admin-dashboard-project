  ...
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      <form action={formAction} className="bg-white p-6 rounded-xl border shadow-sm space-y-4">
        ...
        <div className={step === 1 ? "block space-y-4 animate-in fade-in transition-all" : "hidden"}>
        ...
        <div className={step === 2 ? "block space-y-4 animate-in fade-in transition-all" : "hidden"}>
